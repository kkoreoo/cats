...
describe('#breedDetails', () => {
  ...
  it('returns breed detials for Balinese breed', () => {
  ...
  it('returns undefined when a species not listed is inputted', () => {
    const expectedDesc = undefined;
    const noSpecies = breedDetails('Not a Species');
    assert.equal(expectedDesc, noSpecies);
  })
});